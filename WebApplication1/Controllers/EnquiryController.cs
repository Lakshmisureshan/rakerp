...
namespace WebApplication1.Controllers
{
    ...
    public class EnquiryController : Controller
    {
        ...
        //    try
        //    {
        //        bool isNewEnquiry = false;
        //        Enquiry enquiryToProcess;
        ...
        //            enquiryToProcess = existingEnquiry;
        //            enquiryToProcess.customerid = request.customerid;
        //            enquiryToProcess.customercontactid = request.customercontactid;
        //            enquiryToProcess.projectmanagerid = request.projectmanagerid;
        //            enquiryToProcess.projectengineerid = request.projectengineerid;
        ...
        //            {
        //                var detail = new Enquirydetails
        //                {
        //                    Enquiryref = request.Enquiryref, // FK to main enquiry
        //                    description = item.description,
        //                    entryuserid = request.userid,

        //                    entrydate = DateTime.UtcNow
        //                };
        //                await dbcontext.Enquirydetails.AddAsync(detail);
        //            }
        //            await dbcontext.SaveChangesAsync();
        //        }
        ...
        //        {
        //            pagename = isNewEnquiry ? "New EnquiryRegistration" : "Enquiry Update",
        //            docno = request.Enquiryref.ToString(),
        ...
        //        return Ok(new { Message = "Enquiry and details saved successfully.", enquiryid = enquiryToProcess.Enquiryref });
        //    }
        //    catch (Exception ex)
        //    {
        //        return StatusCode(500, new { Message = "An error occurred while processing your request.", Details = ex.Message });
        ...
        public async Task<IActionResult> addenquiry(Addenquiry request)
        {
            try
            {
                ...
                var existingEnquiry = await dbcontext.Enquiry
                                               .Include(e => e.EnquiryDetails) // Include details
                                               .FirstOrDefaultAsync(j => j.Enquiryref == request.Enquiryref);
                ...
                if (existingEnquiry != null)
                {
                    ...
                    // Delete existing EnquiryDetails
                    if (enquiryToProcess.EnquiryDetails.Any())
                    {
                        dbcontext.Enquirydetails.RemoveRange(enquiryToProcess.EnquiryDetails);
                    }
                ...
                // Save enquiry first to ensure FK exists
                await dbcontext.SaveChangesAsync();

                // Add new EnquiryDetails
                if (request.items != null && request.items.Any())
                {
                    var details = request.items.Select(item => new Enquirydetails
                    {
                        Enquiryref = request.Enquiryref,
                        description = item.description,
                        entryuserid = request.userid,
                    ...
                    await dbcontext.Enquirydetails.AddRangeAsync(details);
                    await dbcontext.SaveChangesAsync();
                }
        ...
        .Include(t => t.ProjectManager)
             .Include(t => t.Enquirytype)
              ...
              .FirstOrDefaultAsync();
                ...
                //            var enquirydetails = await dbcontext.Enquiry
                //.Include(e => e.EnquiryDetails)
                //.FirstOrDefaultAsync(e => e.Enquiryref == enquiryno);
