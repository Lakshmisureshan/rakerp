...
namespace WebApplication1.Migrations
{
    ...
    [Migration("20241014114053_Add purchasedetails rv1")]
    partial class Addpurchasedetailsrv1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PRDetailsPurchasedetails", b =>
                {
                    ...
                    b.HasKey("Purchasedetailspotblid", "prdetailsprtblid");
            ...
            modelBuilder.Entity("WebApplication1.Models.Domain.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "59cc1171-8988-4ccf-9b79-6bd6cc7fd505",
                            Email = "admin@trading.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@TRADING.COM",
                            NormalizedUserName = "ADMIN@TRADING.COM",
                            PasswordHash = "AQAAAAEAACcQAAAAEDVRLhPSziXawE2xqagZeRa83tD7kHC45+TvM+e0Psr6AurEYidxim2nuxiDk2k1zA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "223d4b72-1595-40b5-b6ed-a29405022d7c",
            ...
            modelBuilder.Entity("WebApplication1.Models.Domain.Purchasedetails", b =>
                {
                    ...
                    b.Property<double>("poquantity")
                        .HasColumnType("float");

                    b.Property<double>("pounitprice")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("PRDetailsPurchasedetails", b =>
                {
                    b.HasOne("WebApplication1.Models.Domain.Purchasedetails", null)
                        .WithMany()
                        .HasForeignKey("Purchasedetailspotblid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebApplication1.Models.Domain.PRDetails", null)
                        .WithMany()
