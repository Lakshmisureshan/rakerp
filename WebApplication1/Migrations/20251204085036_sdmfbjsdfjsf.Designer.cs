...
namespace WebApplication1.Migrations
{
    ...
    [Migration("20251204085036_sdmfbjsdfjsf")]
    partial class sdmfbjsdfjsf
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = "ac03c6a-062b-4818-bd2a-ea5f16cc4a1c",
                            ConcurrencyStamp = "e76b0657-67f3-4e84-9320-1ed68a80a8f5",
                            Name = "FIXEDBUDGETROLE",
                            NormalizedName = "FIXEDBUDGETROLE"
                        },
                        new
                        {
                        ...
                        new
                        {
                            Id = "a2e8c4f1-3b6d-4e90-b1c7-5f2a9d8c0b3e",
                            ConcurrencyStamp = "a2e8c4f1-3b6d-4e90-b1c7-5f2a9d8c0b3e",
                            Name = "JOB FREEZE ROLE",
                            NormalizedName = "JOB FREEZE ROLE"
                        });
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<string>", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = "356ff228-0e5f-436a-9ac5-2d760b997dd5",
                            RoleId = "a2e8c4f1-3b6d-4e90-b1c7-5f2a9d8c0b3e"
                        });
                });
            ...
            modelBuilder.Entity("WebApplication1.Models.Domain.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "0fbd763d-ec2c-42d0-9c4b-229f9444f7b1",
                            Email = "admin@trading.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@TRADING.COM",
                            NormalizedUserName = "ADMIN@TRADING.COM",
                            PasswordHash = "AQAAAAEAACcQAAAAEFV2iMS+DLzW8SDCjVgI5jh6FYBWQTgd7axdyhKWciAI1caH444CxJ/lmhzH/i+bxw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "9d1eb4a7-ba7c-4af4-b7e1-3b093a31a428",
            ...
            modelBuilder.Entity("WebApplication1.Models.Domain.CompanyInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("Bank1AEDAccount")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Bank1Branch")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("Bank1SWIFT")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Bank1USDAccount")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Bank2AEDAccount")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Bank2Branch")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("Bank2SWIFT")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Bank2USDAccount")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ClarificationContact")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("ClarificationDays")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("InvoiceFormatNo")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("WebApplication1.Models.Domain.deliverydetails", b =>
                {
                    b.Property<int>("did")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebApplication1.Models.Domain.DeliveryNote", b =>
                {
                    ...
                    b.Property<string>("buyeriec")
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime>("buyerlpodate")
                        .HasColumnType("datetime2");

                    b.Property<string>("buyerlpono")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("buyertrnno")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("consigneeaddress")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("consigneeiec")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("consigneelpodate")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("consigneelpono")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("consigneename")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("consigneetrnno")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("WebApplication1.Models.Domain.Enquirydetails", b =>
                {
                    b.Property<int>("enqtblid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("enqtblid"), 1L, 1);
                    ...
                    b.ToTable("Enquirydetails");
                });

            modelBuilder.Entity("WebApplication1.Models.Domain.Enquirystatus", b =>
                {
            ...
            modelBuilder.Entity("WebApplication1.Models.Domain.grntracking", b =>
                {
                    ...
                    b.Property<DateTime?>("actualgrndate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("WebApplication1.Models.Domain.Job", b =>
                {
                    ...
                    b.Property<int>("bomjobrevno4")
                        .HasColumnType("int");

                    b.Property<int>("bomjobrevno5")
                        .HasColumnType("int");

                    b.Property<int>("bomjobrevno6")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("bomjobstatusid4")
                        .HasColumnType("int");

                    b.Property<int>("bomjobstatusid5")
                        .HasColumnType("int");

                    b.Property<int>("bomjobstatusid6")
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("ordervaluebasecurrency")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("ordervaluewithvat")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal>("pruexpense1")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("pruexpense2")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("WebApplication1.Models.Domain.jobamend", b =>
                {
                    b.Property<int>("amid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("amid"), 1L, 1);

                    b.Property<DateTime>("amenddate")
                        .HasColumnType("datetime2");

                    b.Property<string>("amenduserid")
                        .HasColumnType("nvarchar(450)");

                    b.Property<decimal>("amendvalueinbasecurrency")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("WebApplication1.Models.Domain.MIdetails", b =>
                {
                    b.Property<int>("mitblid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("mitblid"), 1L, 1);
            ...
            modelBuilder.Entity("WebApplication1.Models.Domain.PO", b =>
                {
                    ...
                    b.Property<string>("otherpaymentremarks")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("WebApplication1.Models.Domain.Preferreduomperproducts", b =>
                {
                    b.Property<int>("pid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("multiplyfactor")
                        .HasColumnType("decimal(18,2)");

                    b.Property<int>("prefuomid")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("prefuomid");

                    b.ToTable("Preferreduomperproducts");
                });
            ...
            modelBuilder.Entity("WebApplication1.Models.Domain.Purchasedetails", b =>
                {
                    ...
                    b.Property<decimal>("inspholdqty")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("insprejectedqty")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("WebApplication1.Models.Domain.deliverydetails", b =>
                {
                    b.HasOne("WebApplication1.Models.Domain.DeliveryNote", "DeliveryNote")
                        .WithMany()
            ...
            modelBuilder.Entity("WebApplication1.Models.Domain.Enquiry", b =>
                {
                    ...
                    b.HasOne("WebApplication1.Models.Domain.JobType", "Enquirytype")
                        .WithMany()
            ...
            modelBuilder.Entity("WebApplication1.Models.Domain.Enquirydetails", b =>
                {
                    ...
                    b.Navigation("linedetailentryuser");
                });
            ...
            modelBuilder.Entity("WebApplication1.Models.Domain.jobamend", b =>
                {
                    b.HasOne("WebApplication1.Models.Domain.ApplicationUser", "Amendedby")
                        .WithMany()
                        .HasForeignKey("amenduserid")
                        .OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity("WebApplication1.Models.Domain.MIdetails", b =>
                {
                    ...
                    b.HasOne("WebApplication1.Models.Domain.Materialinspection", "Materialinspection")
                        .WithMany()
                        .HasForeignKey("mid")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("WebApplication1.Models.Domain.Preferreduomperproducts", b =>
                {
                    ...
                    b.HasOne("WebApplication1.Models.Domain.UOM", "Prefuom")
                        .WithMany()
                        .HasForeignKey("prefuomid")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.Navigation("Prefuom");
