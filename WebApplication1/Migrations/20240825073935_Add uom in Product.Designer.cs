...
namespace WebApplication1.Migrations
{
    ...
    [Migration("20240825073935_Add uom in Product")]
    partial class AdduominProduct
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "a5e6b0d6-d915-45e4-a272-8f354926e202",
                            Email = "admin@trading.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@TRADING.COM",
                            NormalizedUserName = "ADMIN@TRADING.COM",
                            PasswordHash = "AQAAAAEAACcQAAAAEFuIzncf3VG5PLQy9FVWgE5jMkEM5I1awDGlT+SfgpArwF0FL/X/oVyNvvuzoX8vMw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "917d6da9-a214-4d7c-910f-d796abc341be",
            ...
            modelBuilder.Entity("WebApplication1.Models.Domain.UomMultiplyingFactor", b =>
                {
                    b.HasOne("WebApplication1.Models.UOM", "FROMUOM")
                        .WithMany()
                    ...
                    b.HasOne("WebApplication1.Models.UOM", "TOUOM")
                        .WithMany()
